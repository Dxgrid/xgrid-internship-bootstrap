...
# Auto-setup container handles schema initialization
...
resource "aws_db_instance" "temporal" {
  ...
  final_snapshot_identifier = "${var.project_name}-${var.environment}-temporal-final-snapshot-${formatdate("YYYY-MM-DD-hhmm", timestamp())}"
