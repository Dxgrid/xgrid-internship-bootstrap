...
output "services_repository_url" {
  description = "URL of the shared mock-services ECR repository (without tag)."
  value       = aws_ecr_repository.services.repository_url
}

output "services_repository_name" {
  description = "Name of the shared mock-services ECR repository."
